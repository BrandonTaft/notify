...
import { updateUserPrivateRoom } from "../utils/api";
...
const DirectMessageScreen = ({ route, navigation }) => {
    ...
    //lvakconsole.log("recipientIsLogged",recipientIsLogged)
    ...
    const handleNewPrivateMessage = () => {
        ...
        if (notifyUser.userName) {
            console.log("recipientIsLogged",recipientIsLogged)
            const newPrivateMessage = {
                ...
                updateUserPrivateRoom(recipientId, notifyUser._id, notifyUser.userName, newPrivateMessage)
